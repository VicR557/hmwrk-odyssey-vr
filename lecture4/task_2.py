...
# CODUL TĂU VINE MAI JOS:
print("Ultimul caracter este:", name[-1])
# CODUL TĂU VINE MAI SUS:
...
# CODUL TĂU VINE MAI JOS:
print("Cuvantul python este prezent in text:", 'python' in text)
# CODUL TĂU VINE MAI SUS:
...
# CODUL TĂU VINE MAI JOS:
f_string = f'Hola! Ma numesc {name} si altii imi spun {name2}.'
print(f_string)
# CODUL TĂU VINE MAI SUS:
